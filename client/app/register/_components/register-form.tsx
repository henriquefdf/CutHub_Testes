              ...
              render={({ field: { onChange, ref, value } }) => (
                <FormItem className="mb-2 w-full min-w-">
                  ...
                  <div className="flex items-center relative">
                    <label
                      htmlFor="file-upload"
                      className={`flex justify-between h-10 items-center w-full rounded-md border border-input bg-background px-3 py-2 text-sm cursor-pointer focus-within:ring-2 focus-within:ring-ring ${
                        value
